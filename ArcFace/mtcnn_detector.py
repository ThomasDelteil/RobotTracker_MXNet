    ...
    def detect_face_limited(self, img, det_type=2):
        ...
        if det_type>=2:
            ...
            for i in range(num_box):
                ...
                input_buf[i, :, :, :] = adjust_input(resize(tmp, (24, 24), preserve_range=True))
        ...
        for i in range(num_box):
            ...
            tmp[dy[i]:edy[i]+1, dx[i]:edx[i]+1, :] = img[y[i]:ey[i]+1, x[i]:ex[i]+1, :]
            input_buf[i, :, :, :] = adjust_input(resize(tmp, (48, 48), preserve_range=True))
        ...
        for i in range(5):
            ...
            for j in range(num_box):
                ...
                input_buf[j, i*3:i*3+3, :, :] = adjust_input(resize(tmpim, (24, 24), preserve_range=True))
